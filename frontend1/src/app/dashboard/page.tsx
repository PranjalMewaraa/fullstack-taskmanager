  ...
  return (
    <main className="min-h-screen bg-app-gradient px-4 py-6 md:px-6">
      <div className="mx-auto max-w-5xl">
        <header className="mb-5 rounded-2xl border border-slate-300/80 bg-white/75 p-4 shadow-card backdrop-blur">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <div className="mb-1 inline-flex items-center gap-1 rounded-full bg-slate-100 px-2.5 py-1 text-xs font-semibold text-slate-600">
          ...
          <div className="mt-4 grid gap-2 sm:grid-cols-2">
            <div className="rounded-xl border border-slate-200 bg-white p-3">
              <p className="inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-wide text-slate-500">
                <Target size={13} /> Total Tasks
              </p>
              <p className="mt-1 text-2xl font-black text-ink">{tasks.length}</p>
            </div>
            <div className="rounded-xl border border-amber-200 bg-amber-50/60 p-3">
              <p className="inline-flex items-center gap-1 text-xs font-semibold uppercase tracking-wide text-amber-700">
                <Sparkles size={13} /> Pending in view
              </p>
